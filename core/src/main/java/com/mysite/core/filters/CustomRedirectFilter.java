...
@ServiceDescription("Demo to redirec filter incoming requests")
...
public class CustomRedirectFilter implements Filter {
    ...
    public void doFilter(final ServletRequest request, final ServletResponse response,
        ...
        if (slingHttpServletRequest.getParameter("r302") != null) {
            slingHttpServletResponse.sendRedirect("https://www.google.it");
            return;
        }

        if (slingHttpServletRequest.getParameter("r301") != null) {
            slingHttpServletResponse.setStatus(301);
            slingHttpServletResponse.setHeader("Location", "https://www.google.it");
            return;
        }
